...
import {
  asyncDeletedoctorProfile,
  asyncSingledoctorProfile,
} from "../store/actions/doctorProfileAction";
        ...
        <div className="max-w-3xl mx-auto mt-6 px-4 sm:px-6 lg:px-8 p-6 rounded-xl shadow-md border border-gray-200 bg-white">
          ...
          <div className="mt-6 space-y-4 text-sm sm:text-base">
            ...
            <div className="flex justify-between">
              <Button
                onClick={() =>
                  navigate(`/appointment-create/${singleDoctorProfile._id}`)
                }
              >
                Take Appointment
              </Button>
              {user?._id == singleDoctorProfile?.user?._id && (
                <Button
                  className="bg-red-500 hover:bg-red-400"
                  onClick={() => dispatch(asyncDeletedoctorProfile(navigate))}
                >
                  Delete Profile
                </Button>
              )}
