    ...
    <Suspense fallback={<div className="text-center mt-10">Loading...</div>}>
      <Routes>
        ...
        <Route element={<ProtectedRoutes />}>
          ...
          <Route path="/update/prescription/:id" element={<PrescriptionUpdate />} />
          <Route path="/create/medicalrecord/:id" element={<MedicalRecordForm />} />
          <Route path="/update/medicalrecord/:id" element={<MedicalRecordupdateForm />} />
